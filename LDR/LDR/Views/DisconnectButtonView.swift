...
struct DisconnectButtonView: View {
    var disconnectButton: DisconnectButtonViewViewModel
    
    var body: some View {
        Button {
            Task {
                _ = await disconnectButton.disconnectFriend()
            }
        } label: {
...
#Preview {
    DisconnectButtonView(disconnectButton: DisconnectButtonViewViewModel(User(id: "BgvoT3j8TIftJMA1zmjn3rEQLTA3",
                                                                           name: "weishihang",
                                                                           email: "asdfgis@g.com",
